    ...
    while($row=mysqli_fetch_assoc($result))
    {
      ...
      <div class="notes">
        ...
        <div class="tooltip">
              ...
              <div class="tooltip">
                <a href="archieve.php?dida=<?php echo $row ['id'] ?>"><img class="material-icons-outlined hover small-icon" width="35" height="35" src="delete.png" 
                  ></a>  
                
                <span class="tooltip-text">Unarchieve</span>
              </div>
        </div>
